...
describe('Contacts', function () {
    ...
    it(" create a contact", function (done) {
        ...
        server.inject(options, function (response) {
            ...
            expect(contact.contact['middle_initial']).to.equal("p");
...
it("create a contact fail last_name required validation", function(done) {  
    ...
    server.inject(options, function(response) {
        ...
        expect(result.message).to.equal("child \"contact\" fails because [child \"last_name\" fails because [\"last_name\" is required]]");
...
it("create a contact fail email format validation", function(done) {  
    ...
    server.inject(options, function(response) {
        ...
        expect(result.message).to.equal("child \"contact\" fails because [child \"email\" fails because [\"email\" must be a valid email]]");
